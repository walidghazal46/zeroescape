...
export function SignUpScreen() {
  ...
  if (!isMobileApp()) {
    return (
      <div dir="rtl" className="fixed inset-0 bg-background flex flex-col items-center justify-center gap-6 px-6 text-center">
        <Smartphone className="w-14 h-14 text-sky-400" />
        <div>
          <h2 className="text-foreground text-xl font-bold mb-2">التسجيل متاح على الموبايل فقط</h2>
          <p className="text-muted-foreground text-sm">حمّل التطبيق على هاتفك الأندرويد للتسجيل</p>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-foreground text-xl font-bold">إنشاء حساب جديد</h1>
          <p className="text-muted-foreground text-xs">انضم إلى ZeroEscape No.1</p>
        </div>
      </div>

      <form onSubmit={handleSignUp} className="flex-1 space-y-5 mb-6">
        <div>
          <label className="text-muted-foreground text-sm mb-2 block">الاسم الكامل</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-card border border-border rounded-2xl px-4 py-4 pr-12 text-foreground placeholder:text-muted-foreground focus:border-blue-500 focus:outline-none transition"
              required
            />
          </div>
        </div>
        ...
        <div>
          <label className="text-muted-foreground text-sm mb-2 block">البريد الإلكتروني</label>
          <div className="relative">
        ...
        <div>
          <label className="text-muted-foreground text-sm mb-2 block">كلمة المرور</label>
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full bg-card border border-border rounded-2xl px-4 py-4 pr-12 pl-12 text-foreground placeholder:text-muted-foreground focus:border-blue-500 focus:outline-none transition"
              required
            />
            <button
              type="button"
          ...
          <p className="text-muted-foreground text-xs mt-2 mr-1">يجب أن تحتوي على 8 أحرف على الأقل</p>
        </div>

        <div>
          <label className="text-muted-foreground text-sm mb-2 block">تأكيد كلمة المرور</label>
          <div className="relative">
            <Lock className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
            <input
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-2xl p-4 space-y-4">
          ...
          <div>
            <label className="text-muted-foreground text-sm mb-2 block">رمز الطوارئ</label>
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••"
                className="w-full bg-card border border-yellow-500/40 rounded-2xl px-4 py-4 pr-12 text-foreground text-center tracking-widest text-xl focus:border-yellow-500 focus:outline-none transition"
                required
              />
            </div>
          </div>
          <div>
            <label className="text-muted-foreground text-sm mb-2 block">تأكيد رمز الطوارئ</label>
            <div className="relative">
              <Lock className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-yellow-500" />
              <input
                type="password"
